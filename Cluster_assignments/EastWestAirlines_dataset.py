# -*- coding: utf-8 -*-
"""
Created on Sun Aug 25 17:15:59 2024

@author: Sai
"""
'''1.Perform K means clustering on the airlines dataset to obtain optimum number
 of clusters. Draw the inferences from the clusters obtained. Refer to
 EastWestAirlines.xlsx dataset.'''

#Business Objective - 
'''
is to find clusters of passengers that are of the similar characteristics
to provide milage offers based on groups
'''
import pandas as pd
...
airlines = pd.read_excel("F:/Data science/ML/EastWestAirlines.xlsx")
...
df_normal.to_csv("F:/Data science/ML/EastWestAirlines.xlsx")
import os
os.getcwd()
