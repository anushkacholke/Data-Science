# -*- coding: utf-8 -*-
"""
Created on Sun Aug 25 18:00:31 2024

@author: Sai
"""
'''4.Perform clustering analysis on the telecom dataset. The data is a mixture
 of both categorical and numerical data. It consists of the number of customers
 who churn. Derive insights and get possible information on factors that may affect 
...
t_data = pd.read_excel("F:/Data science/ML/Telco_customer_churn.xlsx")
t_data.describe()
t_data.columns
t_data.dtypes
t_data.shape
...
df_normal.to_csv("F:/Data science/ML/Telco_customer_churn.xlsx")
import os
os.getcwd()
